...
```
# Contexto
Você é um especialista personal trainer e vai me ajudar a montar um treino ideial, baseado nas três variáveis abaixo:
...
- Mobilidade Melhora a funcionalidade e amplitude


# Resultado esperado
com base nos valores informados na área de variáveis e com as guidelines, crie uma lista de treino ideal para a pessoa que corresponde a combinação desses 4 valores
```